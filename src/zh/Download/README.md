...
- 如何从 v0.13.x 升级到 v1.0.x？
  * 0.13版本与1.0版本的文件目录结构不同，**<font color=red>不能将0.13的data目录直接拷贝到1.0集群使用</font>**。如果需要将0.13的数据导入至1.0，可以使用[LOAD](../UserGuide/V1.0.x/Maintenance-Tools/Load-Tsfile.md)功能;
